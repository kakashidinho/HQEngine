...
typedef enum _HQTextureUAVFormat {
	...
	HQ_UAVTFMT_R8G8B8A8_UNORM, //8 bit per channel, when use as input, each channel will be converted to floating point between [0..1] in shader. while in Direct3d11, when use as UAV for reading, it will be uint format instead of float4
