...
public:
	...
	///Direct3d 11 : {slot} = {texture slot} bitwise OR with enum HQShaderType to specify  {texture slot} belongs to which shader stage. 
	...
	///
	virtual HQReturnVal SetTextureUAV(hq_uint32 slot, HQTexture* textureID, hq_uint32 mipLevel = 0, bool read = false) = 0;
