...
#elif MYGUI_PLATFORM == MYGUI_PLATFORM_WINRT

//winRT doesn't support dll lib

#    define MYGUI_DYNLIB_HANDLE void*
#    define MYGUI_DYNLIB_LOAD( a ) NULL
#    define MYGUI_DYNLIB_GETSYM( a, b ) NULL
#    define MYGUI_DYNLIB_UNLOAD( a ) false
